...
#Proxy setup for lmg
#ENV http_proxy 'http://165.225.88.32:9400'
#ENV https_proxy 'https://165.225.88.32:9400'
...
#RUN mkdir -p configs
#RUN mkdir -p tessconfigs

#WORKDIR ${DIST}/tesseract/share/tessdata/configs
#RUN curl -L https://github.com/tesseract-ocr/tessconfigs/blob/master/configs/makebox > makebox
#WORKDIR ${DIST}/tesseract/share/tessdata/tessconfigs
#RUN curl -L https://github.com/tesseract-ocr/tessconfigs/blob/master/tessconfigs/batch.nochop > batch.nochop

#COPY configs/* ${DIST}/tesseract/share/tessdata/configs/
#COPY tessconfigs/* ${DIST}/tesseract/share/tessdata/tessconfigs/
